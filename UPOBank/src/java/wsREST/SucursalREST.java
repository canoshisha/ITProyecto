...
/**
 * Jersey REST client generated for REST resource:SucursalFacadeREST
 * [entidades.sucursal]<br>
 * USAGE:
 * <pre>
 *        SucursalREST client = new SucursalREST();
...
public class SucursalREST {
    ...
    public SucursalREST() {
        ...
        webTarget = client.target(BASE_URI).path("entidades.sucursal");
    }
