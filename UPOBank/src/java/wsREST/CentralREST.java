...
/**
 * Jersey REST client generated for REST resource:CentralFacadeREST
 * [entidades.central]<br>
 * USAGE:
 * <pre>
 *        CentralREST client = new CentralREST();
...
public class CentralREST {
    ...
    public CentralREST() {
        ...
        webTarget = client.target(BASE_URI).path("entidades.central");
    }
