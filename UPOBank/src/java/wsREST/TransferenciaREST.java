...
/**
 * Jersey REST client generated for REST resource:TransferenciaFacadeREST
 * [entidades.transferencia]<br>
 * USAGE:
 * <pre>
 *        TransferenciaREST client = new TransferenciaREST();
...
public class TransferenciaREST {
    ...
    public TransferenciaREST() {
        ...
        webTarget = client.target(BASE_URI).path("entidades.transferencia");
    }
